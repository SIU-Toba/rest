...
class autenticacion_digest_http extends proveedor_autenticacion
{
    ...
    public function __construct(usuarios_password $pu)
    {
        $this->passwords = $pu;
    }
    ...
    public function requerir_autenticacion(respuesta_rest &$rta)
    {
        ...
        $rta = $rta
                ->add_headers(array('WWW-Authenticate' => \utf8_e_seguro($header)))
                ->set_data(array('mensaje' => \utf8_e_seguro('autenticaci髇 cancelada')));
    }
